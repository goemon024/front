            ...
            <div className={styles["content-container"]}>
                ...
                <div className={styles["memo-container"]}>
                    <div className={styles["memo-upper-container"]}>
                        ...
                        <CardButton titleText="チェックリスト" detailText1="重点的に復習する例文（編集ボタンでチェック）" href="/sentence/checklist" />
                    </div>
                </div>
            </div>
            <TagButton text="編集（チェック）" link="/sentencelist" top="25%" backgroundColor="rgba(52, 152, 219, 0.8)" color="white" />
