    ...
    >
      <div className={styles['main-container']}>
        <div className={styles['menu-container']}>
          ...
          <Link to="/wordlist">
            <button className="media-large btn btn-secondary mb-2" style={{ marginTop: '1rem' }}>
              英単語帳編集
            </button>
          </Link>
          ...
          >
            <form onSubmit={handleSubmit1}>
              <p style={{ fontSize: '20px', marginBottom: '10px', alignSelf: 'flex-start' }}>
                英単語ドリル
              </p>
              <div
                style={{ display: 'flex', justifyContent: 'flex-end', gap: '1em', width: '100%' }}
              >
                <label htmlFor="start_date" style={{ justifyContent: 'flex-start' }}>
                  From:
                </label>
                <input
                  type="date"
        ...
        <div className={styles['content-container']}>
          ...
          <div className={styles['container']} style={{ display: 'flex', margin: '20px' }}>
            <div
              id={styles['menu1']}
              style={{ border: '8px solid greenyellow', backgroundColor: 'rgba(0,100,100,0.2)' }}
            >
              <h3>英単語帳</h3>
              <Link to="/word/create">
            ...
            <div
              id={styles['menu2']}
              style={{ border: '8px solid #339fff', backgroundColor: 'rgba(50,100,150,0.2)' }}
            >
              <h3>メモ帳１</h3>
            ...
            <div
              id={styles['menu1']}
              style={{ border: '8px solid #55d0ff', backgroundColor: 'rgba(60,100,60,0.2)' }}
            >
              <h3>メモ帳２</h3>
          ...
          <button className={styles['logout']} onClick={handleLogout} aria-label="ログアウト">
            ログアウト
          </button>
        </div>
      </div>{' '}
